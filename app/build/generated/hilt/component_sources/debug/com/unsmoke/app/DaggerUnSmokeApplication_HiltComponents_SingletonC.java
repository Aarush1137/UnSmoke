...
import com.unsmoke.app.feature.analytics.AnalyticsViewModel;
...
import com.unsmoke.app.feature.plan.PlanViewModel;
...
public final class DaggerUnSmokeApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends UnSmokeApplication_HiltComponents.ActivityC {
    ...
    private static final class LazyClassKeyProvider {
      ...
      static String com_unsmoke_app_feature_analytics_AnalyticsViewModel = "com.unsmoke.app.feature.analytics.AnalyticsViewModel";
      ...
      @KeepFieldType
      AnalyticsViewModel com_unsmoke_app_feature_analytics_AnalyticsViewModel2;
  ...
  private static final class ViewModelCImpl extends UnSmokeApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.cravingViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
      ...
      this.journalViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 6);
      this.nRTViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 7);
      ...
      this.progressViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 11);
      this.recoveryViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 12);
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>builderWithExpectedSize(15).put(LazyClassKeyProvider.com_unsmoke_app_feature_achievements_AchievementsViewModel, ((Provider) achievementsViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_analytics_AnalyticsViewModel, ((Provider) analyticsViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_checkin_CheckInViewModel, ((Provider) checkInViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_craving_CravingViewModel, ((Provider) cravingViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_home_HomeViewModel, ((Provider) homeViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_insights_InsightsViewModel, ((Provider) insightsViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_journal_JournalViewModel, ((Provider) journalViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_nrt_NRTViewModel, ((Provider) nRTViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_onboarding_OnboardingViewModel, ((Provider) onboardingViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_plan_PlanViewModel, ((Provider) planViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_profile_ProfileViewModel, ((Provider) profileViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_progress_ProgressViewModel, ((Provider) progressViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_recovery_RecoveryViewModel, ((Provider) recoveryViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_settings_SettingsViewModel, ((Provider) settingsViewModelProvider)).put(LazyClassKeyProvider.com_unsmoke_app_feature_splash_SplashViewModel, ((Provider) splashViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.unsmoke.app.feature.analytics.AnalyticsViewModel 
          return (T) new AnalyticsViewModel(singletonCImpl.cravingRepositoryImplProvider.get(), singletonCImpl.quitAttemptRepositoryImplProvider.get(), singletonCImpl.healthConnectRepositoryProvider.get());

          case 2: // com.unsmoke.app.feature.checkin.CheckInViewModel 
          ...
          case 3: // com.unsmoke.app.feature.craving.CravingViewModel 
          ...
          case 4: // com.unsmoke.app.feature.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.nRTRepositoryImplProvider.get(), singletonCImpl.quitAttemptRepositoryImplProvider.get(), singletonCImpl.cravingRepositoryImplProvider.get(), singletonCImpl.aiInsightsRepositoryProvider.get(), singletonCImpl.provideUserPreferencesDataStoreProvider.get());

          case 5: // com.unsmoke.app.feature.insights.InsightsViewModel 
          return (T) new InsightsViewModel(singletonCImpl.cravingRepositoryImplProvider.get(), singletonCImpl.quitAttemptRepositoryImplProvider.get(), singletonCImpl.nRTRepositoryImplProvider.get());

          case 6: // com.unsmoke.app.feature.journal.JournalViewModel 
          ...
          case 7: // com.unsmoke.app.feature.nrt.NRTViewModel 
          ...
          case 8: // com.unsmoke.app.feature.onboarding.OnboardingViewModel 
          ...
          case 9: // com.unsmoke.app.feature.plan.PlanViewModel 
          return (T) new PlanViewModel(singletonCImpl.provideUserPreferencesDataStoreProvider.get());

          case 10: // com.unsmoke.app.feature.profile.ProfileViewModel 
          ...
          case 11: // com.unsmoke.app.feature.progress.ProgressViewModel 
          ...
          case 12: // com.unsmoke.app.feature.recovery.RecoveryViewModel 
          return (T) new RecoveryViewModel(singletonCImpl.quitAttemptRepositoryImplProvider.get());

          case 13: // com.unsmoke.app.feature.settings.SettingsViewModel 
          return (T) new SettingsViewModel(singletonCImpl.provideUserPreferencesDataStoreProvider.get(), singletonCImpl.cravingRepositoryImplProvider.get(), singletonCImpl.nRTRepositoryImplProvider.get(), singletonCImpl.quitAttemptRepositoryImplProvider.get(), singletonCImpl.provideUnSmokeDatabaseProvider.get());

          case 14: // com.unsmoke.app.feature.splash.SplashViewModel 
  ...
  private static final class SingletonCImpl extends UnSmokeApplication_HiltComponents.SingletonC {
    ...
    private Provider<AiInsightsRepository> aiInsightsRepositoryProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.healthConnectRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<HealthConnectRepository>(singletonCImpl, 6));
      this.checkInRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<CheckInRepositoryImpl>(singletonCImpl, 7));
      this.aiInsightsRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<AiInsightsRepository>(singletonCImpl, 8));
    }
    ...
    @CanIgnoreReturnValue
    private StreakWidgetReceiver injectStreakWidgetReceiver2(StreakWidgetReceiver instance) {
      StreakWidgetReceiver_MembersInjector.injectQuitAttemptRepo(instance, quitAttemptRepositoryImplProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.unsmoke.app.core.data.repository.QuitAttemptRepositoryImpl 
          ...
          case 6: // com.unsmoke.app.core.data.repository.HealthConnectRepository 
          ...
          case 7: // com.unsmoke.app.core.data.repository.CheckInRepositoryImpl 
          return (T) new CheckInRepositoryImpl(singletonCImpl.checkInDao());

          case 8: // com.unsmoke.app.core.domain.repository.AiInsightsRepository 
          return (T) new AiInsightsRepository();
