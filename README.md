...
│   ├── data/              # Room DAOs, DataStore, Repositories, Entities
│   ├── domain/            # CalculationEngine, NRTTaperingEngine, Achievements
│   ├── designsystem/      # Theme, Typography, AppColors, Shared Composables
├── feature/               # Feature modules (MVVM structure)
│   ├── home/              # Dashboard, savings overview, daily stats
│   ├── onboarding/        # First-time user setup & baseline capture
│   ├── progress/          # Streak tracking, badges, weekly lung check-ins
│   ├── cravings/          # Urge surfing, craving timer, coping toolkit
│   ├── nrt/               # Clinical tapering dashboard and logging
